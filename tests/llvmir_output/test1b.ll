...
@zach = global i64 0
@tmp = global i64 0
@0 = global [7 x i8] c"passed\00"
@1 = global [7 x i8] c"passed\00"
...
dummy:
        %i = alloca float
        %tst = alloca i1
        store float 4.5, float* %i
        %0 = getelementptr [7 x i8], [7 x i8]* @0, i64 0, i64 0
        %1 = getelementptr [7 x i8], [7 x i8]* @1, i64 0, i64 0
